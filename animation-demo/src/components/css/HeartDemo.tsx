...
export const HEART_CODE = `/* Transition: hover 状态反馈 */
.btn {
...
@keyframes particle-fly {
  0%   { transform: translate(-50%,-50%)
           rotate(var(--angle)) translateY(0) scale(1);
         opacity: 1; }
  100% { transform: translate(-50%,-50%)
           rotate(var(--angle)) translateY(-40px) scale(0);
         opacity: 0; }
}`
    ...
    <div className="flex flex-col items-center gap-8">
      ...
      >
        <svg
          ...
          stroke="currentColor"
          strokeWidth={2}
          style={{ animation: animating ? 'heartbeat 0.8s ease-in-out' : 'none' }}
        >
